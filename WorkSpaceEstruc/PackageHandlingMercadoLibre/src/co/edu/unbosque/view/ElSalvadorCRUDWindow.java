...
public class ElSalvadorCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8712452566889016933L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public ElSalvadorCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD El Salvador");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD elsalvador.png").getImage();
