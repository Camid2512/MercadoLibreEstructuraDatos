...
public class UruguayCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7015117976406774986L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public UruguayCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Uruguay");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD uruguay.png").getImage();
