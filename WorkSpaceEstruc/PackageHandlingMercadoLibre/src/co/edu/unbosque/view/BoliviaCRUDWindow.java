...
public class BoliviaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1275032703725300272L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public BoliviaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Bolivia");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD bolivia.png").getImage();
