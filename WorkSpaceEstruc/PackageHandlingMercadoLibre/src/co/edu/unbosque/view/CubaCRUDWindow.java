...
public class CubaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2135020813021596086L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public CubaCRUDWindow() {
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD cuba.png").getImage();
