...
public class CostaRicaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3299284258040110828L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public CostaRicaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Costa Rica");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD costa rica.png").getImage();
