...
public class GuyanaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6717908938722596930L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public GuyanaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Guyana");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD guyana.png").getImage();
