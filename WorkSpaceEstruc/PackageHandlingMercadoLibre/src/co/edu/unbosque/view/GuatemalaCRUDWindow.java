...
public class GuatemalaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7466974419051545027L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public GuatemalaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Guatemala");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD guatemala.png").getImage();
