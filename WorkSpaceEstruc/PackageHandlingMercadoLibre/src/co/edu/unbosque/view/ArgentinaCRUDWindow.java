...
public class ArgentinaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7430051361639292682L;
	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public ArgentinaCRUDWindow() {
		// TODO Auto-generated constructor stub
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Argentina");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD argentina.png").getImage();
