...
public class RepDominicanaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5505188163829771773L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public RepDominicanaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Republica Dominicana");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD rep dominicana.png").getImage();
