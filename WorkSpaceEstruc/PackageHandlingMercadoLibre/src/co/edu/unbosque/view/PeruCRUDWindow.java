...
public class PeruCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 249203776703055766L;
	
	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;
	
	public PeruCRUDWindow() {
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD peru.png").getImage();
