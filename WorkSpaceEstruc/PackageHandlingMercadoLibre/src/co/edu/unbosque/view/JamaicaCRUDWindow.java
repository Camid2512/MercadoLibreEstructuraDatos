...
public class JamaicaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6096992725929524665L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public JamaicaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Jamaica");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD jamaica.png").getImage();
