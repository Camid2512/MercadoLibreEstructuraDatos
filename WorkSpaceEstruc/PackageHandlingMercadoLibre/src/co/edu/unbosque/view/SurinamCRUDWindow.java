...
public class SurinamCRUDWindow extends JFrame {
	...
	public SurinamCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Surinam");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD surinam.png").getImage();
