...
public class VenezuelaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8689088765931021168L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public VenezuelaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Venezuela");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD venezuela.png").getImage();
