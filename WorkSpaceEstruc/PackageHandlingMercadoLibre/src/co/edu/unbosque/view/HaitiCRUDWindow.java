...
public class HaitiCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4753093434549477894L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public HaitiCRUDWindow() {
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD haiti.png").getImage();
