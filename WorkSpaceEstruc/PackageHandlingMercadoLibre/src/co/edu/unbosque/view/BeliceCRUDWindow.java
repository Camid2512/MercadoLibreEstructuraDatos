...
public class BeliceCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1602582366738420259L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public BeliceCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Belice");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD belice.png").getImage();
