...
public class ChileCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3376548556577437118L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public ChileCRUDWindow() {
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD chile.png").getImage();
