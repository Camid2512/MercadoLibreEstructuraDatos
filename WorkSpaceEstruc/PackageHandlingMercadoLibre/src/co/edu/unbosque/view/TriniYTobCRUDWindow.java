...
public class TriniYTobCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3995316102237678L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public TriniYTobCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Trinidad y Tobago");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD trinidad y tobajo.png").getImage();
