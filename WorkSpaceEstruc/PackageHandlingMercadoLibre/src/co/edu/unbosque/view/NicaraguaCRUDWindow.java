...
public class NicaraguaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8166694150126826349L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public NicaraguaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Nicaragua");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD nicaragua.png").getImage();
