...
public class EcuadorCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4895684334940089584L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public EcuadorCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Ecuador");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD ecuador.png").getImage();
