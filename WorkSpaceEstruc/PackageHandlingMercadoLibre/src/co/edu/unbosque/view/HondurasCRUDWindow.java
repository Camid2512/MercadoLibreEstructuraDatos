...
public class HondurasCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5241180305861718564L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public HondurasCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Honduras");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD honduras.png").getImage();
