...
public class ParaguayCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7321965155002184049L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public ParaguayCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Paraguay");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD paraguay.png").getImage();
