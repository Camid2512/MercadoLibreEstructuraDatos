...
public class PanamaCRUDWindow extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7245521958742645162L;

	private JLabel mainImage;
	private JButton create, read, update, delete, filter, exit, back;

	public PanamaCRUDWindow() {
		// TODO Auto-generated constructor stub
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD Panama");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/CRUD panama.png").getImage();
